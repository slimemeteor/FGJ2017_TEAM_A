...
public class MapController : MonoBehaviour
{
	...
	public void Start ()
	{
		...
		Debug.Log(string.Format("Player Pos = {0}", GameManager.Instance.GetPlayerPosition(StageIndex)));
	}
...
//		}
	...
	{
		Object res = Resources.Load("Prefab/RockWithGrass", typeof(GameObject));
	...
	{
		Object res = Resources.Load("Prefab/RockNoGrass", typeof(GameObject));
